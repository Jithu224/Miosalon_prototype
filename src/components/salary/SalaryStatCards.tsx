...
import { HiOutlineBanknotes, HiOutlineChartBar, HiOutlineMinusCircle, HiOutlineUserGroup } from 'react-icons/hi2';
...
export function SalaryStatCards({ totalOutflow, totalCommissions, totalDeductions, staffCount }: SalaryStatCardsProps) {
  const cards = [
